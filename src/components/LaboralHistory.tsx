...
interface LaboralHistoryViewProps {
    lang: string;
}

function LaboralHistoryView({lang}: LaboralHistoryViewProps) {
    return (
        <div className="row">
            <div className="col-12 text-center portfolio-main-title">
                <PageTitle title={getString(lang, "LaboralHistoryTitle")}/>
            </div>
...
export default LaboralHistoryView;
